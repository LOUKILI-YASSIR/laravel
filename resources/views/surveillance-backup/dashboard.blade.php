<x-app-layout>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('serviceForm').addEventListener('reset', function(e) {
                // Attendre que le formulaire soit réinitialisé
                setTimeout(() => {
                    // Masquer toutes les sections d'options
                    document.querySelectorAll('.service-options').forEach(optionsDiv => {
                        optionsDiv.style.display = 'none';
                    });
                    
                    // Réinitialiser le total
                    document.getElementById('total').value = '0 MAD';
